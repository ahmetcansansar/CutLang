...
#ifdef VLLd_cxx
VLLd::VLLd(char *file_name, TChain *tree) : fChain(0) 
{
 TChain* chain;
  if (tree == 0) {
...
Int_t VLLd::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t VLLd::LoadTree(Long64_t entry)
{
